...
# SOURCE: https://github.com/tsurumeso/vocal-remover
# Including models/, lib/, augment.py and train.py
...
def direct_call(fname, sr, use_gpu=False):
    ...
    X, sr = librosa.load(
        fname, sr=sr, mono=False, dtype=np.float32, res_type='kaiser_fast'
    )
    force_mono = X.ndim == 1
